...
<form action="<?php echo e(route('bb.store')); ?>" method='POST'>
    ...
    <div class="form-group">
        ...
        <input name='title' id='txtTitle' value="<?php echo e(old('title')); ?>" class="form-controll <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>"
        row='3'><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class='form-group'>
        ...
        <input name='price' id='txtPrice' class="form-controll <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/bb_add.blade.php ENDPATH**/ ?>